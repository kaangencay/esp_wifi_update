...
String content;
String client_data;
const char *led_ac = "ac";
const char *led_kapa = "kapat";

//Establishing Local server at port 80 whenever required
ESP8266WebServer web_server(WEB_SERVER_PORT);
WiFiServer wifi_server(WIFI_SERVER_PORT);
...
void wifi_start(void)
{
    ...
    if (testWifi())
    {
        ...
        Serial.println("wifi_server begin...");
...
WiFiClient check_wifi_server_available()
{
    return wifi_server.available();
}
...
void setupAP(void)
{
    ...
    st += "</ol>";
    delay(100);
    WiFi.softAP("KG_Wifi_Setup", "12345678");
